---
title: "Tornado Plot Environmental Sampling-ASV Approach"
author: "Sarah Daly"
date: '2023-08-25'
output:
...
```{r}
setwd("C:/Users/dalys/OneDrive/Documents/My Documents/Cornell Postdoc Papers/Review Paper/Manuscript/Code/Tornado Plots/ASV")
```
...
setwd(("./tornado_plot"))
write.csv(grp_abund, paste(name, "Mean Abundance Genus ASV.csv", sep=" "))
...
tiff(paste(name, "Mean Compositional Abundance Genus single bar ASV.tif", sep=" "), res=300, compression = "lzw", height=9, width=15, units="in")
print(bar)
dev.off()

pdf(paste(name, "Mean Compositional Abundance Genus single bar ASV.pdf", sep=" "), height=9, width=15)
print(bar)
dev.off()
