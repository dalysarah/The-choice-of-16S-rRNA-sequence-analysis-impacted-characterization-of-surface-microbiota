...
Purpose:  Process High Density samples, ASV-based Pipeline 
Input files: OTU or ASV table (.qza), unfiltered taxonomy table (.qza), rooted photogenic tree (.qza), metadata file (.txt)


#Set Working Directory
```{r}
setwd("C:/Users/dalys/OneDrive/Documents/My Documents/Cornell Postdoc Papers/Review Paper/Manuscript/Code/Pipeline Processing R/High/ASV")
```
...
#Filter samples "High" Density only
```{r}
ps <- subset_samples(ps, sample %in%  c("sample-153", "sample-251","sample-126", "sample-58" , "sample-159", "sample-267" ,"sample-37" , "sample-364","sample-366" ,"sample-270" ,"sample-390", "sample-431" ,"sample-432", "sample-458", "sample-154" ,"sample-380","sample-161", "sample-174", "sample-485", "sample-207", "sample-162", "sample-186", "sample-405", "sample-20" ,"sample-287" ,"sample-359", "sample-459", "sample-13" , "sample-34" , "sample-357", "sample-35" , "sample-332", "sample-461", "sample-428" ,"sample-299", "sample-23" , "sample-477", "sample-372", "sample-21",  "sample-16" ,"sample-132" ,"sample-469", "sample-131" ,"sample-59" , "sample-180", "sample-137", "sample-221" ,"sample-379","sample-150", "sample-340", "sample-312" ,"sample-284", "sample-160", "sample-111", "sample-197" ,"sample-435", "sample-378" ,"sample-41",  "sample-268", "sample-266" ,"sample-413", "sample-362" ,"sample-144", "sample-470", "sample-406" ,"sample-369", "sample-14" , "sample-166" ,"sample-346", "sample-274", "sample-392", "sample-404","sample-145", "sample-482", "sample-370", "sample-286", "sample-243", "sample-355" ,"sample-86"  ,"sample-167","sample-122", "sample-295", "sample-38"  ,"sample-249" ,"sample-360", "sample-26" , "sample-377" ,"sample-263", "sample-164" ,"sample-350" ,"sample-11" , "sample-223", "sample-283", "sample-290" ,"sample-241", "sample-401","sample-116", "sample-444" ,"sample-143", "sample-408"))
...
#Rarefy Data
https://microucph.github.io/amplicon_data_analysis/html/compositionality.html 
```{r}
...
#Change WD and output ps object 
setwd(("./ps_object"))
capture.output((ps.clr), file = "ps.clr.80.txt")
setwd("..")
getwd()
```
...
#write.csv(abund_df, "Mean Abundance Taxa.csv")
