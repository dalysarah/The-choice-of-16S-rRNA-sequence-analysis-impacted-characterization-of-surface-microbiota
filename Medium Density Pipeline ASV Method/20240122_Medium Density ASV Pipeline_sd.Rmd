...
---
Purpose:  Process Medium Density samples, ASV-based Pipeline 
Input files: OTU or ASV table (.qza), unfiltered taxonomy table (.qza), rooted photogenic tree (.qza), metadata file (.txt)

#Set Working Directory
```{r}
setwd("C:/Users/dalys/OneDrive/Documents/My Documents/Cornell Postdoc Papers/Review Paper/Manuscript/Code/Pipeline Processing R/Medium/ASV")
```
...
#Filter samples "Medium" Density only
```{r}
#Add column called "sample" to metadatasheet
ps <- subset_samples(ps, sample %in% c("sample-253", "sample-292", "sample-128", "sample-328", "sample-285", "sample-384", "sample-108", "sample-1", "sample-215", "sample-181" ,"sample-60",  "sample-139", "sample-294", "sample-261" ,"sample-4"  , "sample-64" , "sample-230", "sample-321" ,"sample-188" ,"sample-222" ,"sample-9",   "sample-32" , "sample-484", "sample-462","sample-303", "sample-177", "sample-134", "sample-203", "sample-473", "sample-481", "sample-110", "sample-472","sample-79" , "sample-117", "sample-171","sample-204", "sample-224", "sample-349", "sample-97" , "sample-356","sample-2",  "sample-258" ,"sample-416", "sample-67"  ,"sample-219" ,"sample-244" ,"sample-62" , "sample-339","sample-27",  "sample-314" ,"sample-333" ,"sample-399" ,"sample-36" , "sample-68" , "sample-118","sample-291","sample-368", "sample-170" ,"sample-99" , "sample-331", "sample-220", "sample-193" ,"sample-85" , "sample-52","sample-415", "sample-316" ,"sample-24" , "sample-330", "sample-185", "sample-172", "sample-88" , "sample-56","sample-184", "sample-169", "sample-442", "sample-502", "sample-464" ,"sample-152" ,"sample-232", "sample-467", "sample-311" ,"sample-39" , "sample-136", "sample-361" ,"sample-81",  "sample-388", "sample-259", "sample-483","sample-337" ,"sample-367", "sample-318", "sample-374" ,"sample-505" ,"sample-83" , "sample-479", "sample-460" , "sample-351" ,"sample-386" ,"sample-61" , "sample-140"))
ps
head(sample_data(ps))
```
...
beta_diversity_values(ps.clr, "CLR__none", "CLR", "none", "euclidean")
