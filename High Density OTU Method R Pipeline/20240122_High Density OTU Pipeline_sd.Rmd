...
---
Purpose:  Process High Density samples, OTU-based Pipeline 
Input files: OTU or ASV table (.qza), unfiltered taxonomy table (.qza), rooted photogenic tree (.qza), metadata file (.txt)

#Set Working Directory
```{r}
setwd("C:/Users/dalys/OneDrive/Documents/My Documents/Cornell Postdoc Papers/Review Paper/Manuscript/Code/Pipeline Processing R/High/OTU")
```
...
#Taxa Calcluations -Finding Missing Genera
```{r}
#FUNCTION###########################################################################
